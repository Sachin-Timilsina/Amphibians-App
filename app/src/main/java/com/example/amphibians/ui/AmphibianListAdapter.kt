...
/*
The 'AmphibianListener' class is a simple wrapper class around a
lambda function that takes an 'amphibian' argument and has a single
method 'onClick', which simply calls the lambda function.
 */
